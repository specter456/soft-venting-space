...
export const THEMES: ThemeDef[] = [
  {
    ...
    vars: {
      "--theme-bg-start": "#9CCFF0",
      "--theme-bg-mid": "#C6E6FA",
      "--theme-bg-end": "#EAF7FF",
      "--theme-card": "rgba(255,255,255,0.65)",
      "--theme-card-border": "rgba(200,220,245,0.6)",
      "--theme-text": "#2A4A6A",
      "--theme-text-soft": "#5A7A9A",
      "--theme-accent": "#7BAAD4",
      "--theme-accent-deep": "#5A8ABE",
      "--theme-accent-light": "rgba(200,220,245,0.5)",
      "--theme-blob-1": "rgba(180,210,240,0.3)",
      "--theme-blob-2": "rgba(255,255,255,0.4)",
      "--theme-blob-3": "rgba(200,225,250,0.3)",
      "--theme-header-bg": "rgba(200,225,250,0.8)",
      "--theme-tile-recording": "#7BAAD4",
      "--theme-tile-notes": "#A88BC4",
      "--theme-tile-scribble": "#8CA8D6",
      "--theme-tile-photo": "#8FA8C9",
      "--theme-tile-stickers": "#B79BD9",
      "--theme-tile-gif": "#7F9BD9",
      "--theme-tile-diary": "#6F7BC0",
      "--theme-tile-vault": "#C9A96A",
      "--theme-btn-primary": "#5A8ABE",
