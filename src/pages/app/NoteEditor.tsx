  ...
  return (
    <div className="space-y-5">
      <Textarea
        ...
        className="clay-card min-h-44 resize-none border-0 px-5 py-5 text-[15px] leading-relaxed text-ink-deep shadow-none placeholder:text-ink-soft/70 focus-visible:ring-lavender-300"
      />
